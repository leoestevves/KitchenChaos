...
public class PlateCompleteVisual : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            kitchenObjectSO_GameObject.gameObject.SetActive(false); //Comeca desativado
        }
    }
    ...
    private void PlateKitchenObject_OnIngredientAdded(object sender, PlateKitchenObject.OnIngredientAddedEventArgs e)
    {
        foreach (KitchenObjectSO_GameObject kitchenObjectSO_GameObject in kitchenObjectSO_GameObjectsList)
        {
            ...
            {
                kitchenObjectSO_GameObject.gameObject.SetActive(true); //Ativa o gameobject colocado no prato
            }
        }
    }
}
